...
v8（2026-04-26）句型二/三開場強化（改寫稿取自v7審查報告）
...
para(
    '你說「帶領班兵完成任務」，企業 HR 聽到的是「軍隊的事，跟我沒關係」。',
    space_before=4
)
para('你說「帶領學生達成教學目標」，HR 聽到的是「老師要轉職，不確定她能不能適應企業文化」。')
...
para(
    '我問過很多求職者：你優化了什麼？他們說：報表流程。',
    space_before=4
)
para('我問：優化之前什麼狀況？他們沉默了三秒——因為他們從來沒想過要說這件事。')
para('HR 也沉默了，只是更快，因為他們已經翻到下一份。')
...
out_v5   = os.path.join(base, '讓履歷被看見的5個關鍵句型_完整版_v8.docx')
doc.save(out_main)
doc.save(out_v5)
